<a 
  target="_blank" 
  href="https://chat.whatsapp.com/GeVsOcSVbteDq4S8wy72rk"
  class="inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-green-500 to-blue-600 text-white rounded-xl text-base font-semibold font-jost cursor-pointer transition-all duration-300 hover:from-green-400 hover:to-blue-500 hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(34,197,94,0.4)] active:scale-95 no-underline"
>
  <svg
